            ...
            <div class="col-md-4">
              <div class="property-wrap">
                <a
                  href="#"
                  class="img"
                  style={{ backgroundImage: `url(/images/standardroom.jpeg)` }}
                ></a>
                <div class="text">
                  <p class="price">
                    {/* <span class="old-price">₹ 800,000</span> */}
                    <span class="orig-price">
                      ₹ 2,000 <span class="incl-taxes">(plus taxes)</span>
                    </span>
            ...
            <div class="col-md-4">
              <div class="property-wrap">
                <a
                  href="#"
                  class="img"
                  style={{ backgroundImage: `url(/images/familystandardroom.jpeg)` }}
                ></a>
                <div class="text">
                  <p class="price">
                    {/* <span class="old-price">₹ 800,000</span> */}
                    <span class="orig-price">
                      ₹ 4,000 <span class="plus-taxes">(plus taxes)</span>
                    </span>
            ...
            <div class="col-md-4">
              <div class="property-wrap">
                <a
                  href="#"
                  class="img"
                  style={{ backgroundImage: `url(/images/deluxroom.jpeg)` }}
                ></a>
                <div class="text">
                  <p class="price">
                    {/* <span class="old-price">₹ 800,000</span> */}
                    <span class="orig-price">
                      ₹ 3,000 <span class="plus-taxes">(plus taxes)</span>
                    </span>
              ...
              <div class="property-wrap">
                ...
                <div class="text">
                  <p class="price">
                    {/* <span class="old-price">₹ 800,000</span> */}
                    <span class="orig-price">
                      ₹ 4,500 <span class="plus-taxes">(plus taxes)</span>
                    </span>
